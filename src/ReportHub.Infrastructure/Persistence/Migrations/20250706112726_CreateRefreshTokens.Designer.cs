...
namespace ReportHub.Infrastructure.Migrations
{
    ...
    [Migration("20250706112726_CreateRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReportHub.Domain.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_plans_organization_id");

                    b.ToTable("plans", (string)null);
                });

            modelBuilder.Entity("ReportHub.Domain.PlanItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_plan_items_item_id");

                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_plan_items_organization_id");

                    b.HasIndex("PlanId")
                        .HasDatabaseName("ix_plan_items_plan_id");

                    b.ToTable("plan_items", (string)null);
                });

            modelBuilder.Entity("ReportHub.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ReportHub.Domain.Plan", b =>
                {
                    b.HasOne("ReportHub.Domain.Organization", "Organization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plans_organizations_organization_id");
            ...
            modelBuilder.Entity("ReportHub.Domain.PlanItem", b =>
                {
                    b.HasOne("ReportHub.Domain.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plan_items_items_item_id");
                    ...
                    b.HasOne("ReportHub.Domain.Organization", "Organization")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plan_items_organizations_organization_id");

                    b.HasOne("ReportHub.Domain.Plan", "Plan")
                        .WithMany("PlanItems")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_plan_items_plans_plan_id");
